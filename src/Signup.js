...
const Signup = (props) => {
  return (
    ...
    <View style={{backgroundColor: "#fff", minHeight: '100%'}}>
      <Text style={{textAlign: 'center', marginTop: 20, fontSize: 20, fontWeight: 'bold', color:'#002055'}}>Sign Up</Text>
      <View style={{minWidth: '100%', backgroundColor: "#fff", marginLeft: 20}}>
        <Text style={{color: '#002055', fontSize: 40, marginTop: 60,fontWeight: 'bold',}}>Create Account</Text>
      ...
      <View style={{backgroundColor: 'white', minWidth: '100%', paddingTop: 10, alignItems: 'center', paddingHorizontal: 25}}>
        <Field placeholder="Enter your name" keyboardType={"email-address"} />
        <Field placeholder="Enter your mail" secureTextEntry={true} />
        <Field placeholder="Enter your password" secureTextEntry={true} />
        <Btn textColor="white" bgColor="#756ef3" btnLabel="Sign Up" Press={() => props.navigation.navigate('Home')} />
      ...
      <View style={{textAlign: 'center', paddingTop: 30, marginBottom: 30}}>
        ...
        <TouchableOpacity onPress={() => props.navigation.navigate('Login')}>
          <Text style={{marginLeft:10, color: '#756ef3', fontWeight: 'bold'}}>Sign In</Text>
        </TouchableOpacity>
        </Text>
      </View>
    </View>
